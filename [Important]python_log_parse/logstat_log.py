...
FILLE_NAME = 'LOG-4s-nocompression-60G'
FILLE_NAME = r'G:\1-RocksDB\实验-robin\LOG_rocksdb_robin_statsdump_30s_ycsb_1G_60G_onlyrun_cld'
...
print("The script uses "+(endTime - beginTime))
